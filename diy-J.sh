...
#名称修改
sed -i 's/TVBox/林周影视/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml
#图标修改
...
#添加PY支持
wget --no-check-certificate -qO- "https://raw.githubusercontent.com/c7877/PyramidStore/main/aar/pyramid1010.aar" -O $CURRENT_DIR/$DIR/app/libs/pyramid.aar
